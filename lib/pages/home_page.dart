...
import 'package:chatapp_firebase2/pages/profile_page.dart';
import 'package:chatapp_firebase2/pages/search_page.dart';
...
class _HomePageState extends State<HomePage> {
  String userName = "";
  String email = "";
  AuthService authSetvice = AuthService();
  Stream? groups;
          ...
          children: <Widget>[
            ...
            ListTile(
              onTap: () async {
                ...
                // authSetvice.signOut().whenComplete(() {
